...
!(function (e, t) {
  ...
  function o(e, r, i) {
    ...
    for (
      ...
      ((s = a[2]), (n.locations[s] = t.getUniformLocation(n.id, s)));
    return n;
  }
  function n(e, r) {
  ...
  var s = (function () {
      ...
      (i.push(o("float", t.FLOAT, Float32Array)),
        r.OES_texture_half_float &&
          i.push(
            o("half_float", r.OES_texture_half_float.HALF_FLOAT_OES, null),
          ));
        ...
        if (r != this.imageSource)
          if (((this.imageSource = r), this.imageSource)) {
            ...
            ((i.onload = function () {
              ...
              (i.crossOrigin = this.imageSource.match(/^data:/)
                ? null
                : this.crossOrigin),
  ...
  ((e.fn.ripples = function (t) {
    ...
    return this.each(function () {
      ...
      (o || "string" != typeof t) &&
        (o
          ? "string" == typeof t && h.prototype[t].apply(o, r)
          : i.data("ripples", (o = new h(this, n))));
    });
  }),
